...
const Auton = ({ gears, lowBalls, highBalls, onChange, cross }) => (
  <div>
    ...
    <div className='row' >
      <text> Gears </text>
      <button onClick={() => onChange('autonGears', parseInt(gears, 10) + 1) } > + </button>
      <button onClick={() => {if(parseInt(gears, 10) > 0) onChange('autonGears', parseInt(gears, 10) - 1);}}> - </button>
    ...
    <div className='row' >
      ...
      <button onClick={() => onChange('autonBallsHigh', parseInt(highBalls, 10) + 1)} > + </button>
      <button onClick={() => {if(parseInt(highBalls, 10) > 0) onChange('autonBallsHigh', parseInt(highBalls, 10) - 1);}}> - </button>
    ...
    <div className='row' >
      <text> Low goals </text>
      <button onClick={() => onChange('autonBallsLow', parseInt(lowBalls, 10) + 1)} > + </button>
      <button onClick={() => {if(parseInt(lowBalls, 10) > 0) onChange('autonBallsLow', parseInt(lowBalls, 10) - 1 );} }> - </button>
