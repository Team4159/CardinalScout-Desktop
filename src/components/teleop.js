...
const Teleop = ({ gears, highBalls, lowBalls, onChange, submit, robotDeadTime, climb, reachTouchPad, comments }) => (
  <div>
    ...
    <div className='row' >
      <text> Gears </text>
      <button onClick={() => onChange('teleopGears', parseInt(gears, 10) + 1)}> + </button>
      <button onClick={() => {if(parseInt(gears, 10) > 0) 
        onChange('teleopGears', parseInt(gears, 10) - 1);}}> - </button>
    ...
    <div className='row' >
      ...
      <button onClick={() => onChange('teleopBallsHigh', parseInt(highBalls, 10) + 1)}> + </button>
      <button onClick={() => {if(parseInt(highBalls, 10) > 0) 
        onChange('teleopBallsHigh', parseInt(highBalls, 10) - 1);}}> - </button>
    ...
    <div className='row' >
      <text> Low goals </text>
      <button onClick={() => onChange('teleopBallsLow', parseInt(lowBalls, 10) + 1)}> + </button>
      <button onClick={() => {if(parseInt(lowBalls, 10) > 0) 
        onChange('teleopBallsLow', parseInt(lowBalls, 10) - 1);}}> - </button>
